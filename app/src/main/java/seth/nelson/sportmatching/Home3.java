...
public class Home3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        welBgm = MediaPlayer.create(Home3.this,R.raw.bgm_wel);
        welBgm.start();
        ...
        Animation animation= AnimationUtils.loadAnimation(Home3.this,R.anim.bounce);
    ...
    public void showResFootball() {
        final Dialog dialog=new Dialog(Home3.this);
