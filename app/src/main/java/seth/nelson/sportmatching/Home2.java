...
public class Home2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        welBgm = MediaPlayer.create(Home2.this,R.raw.bgm_wel);
        welBgm.start();
        ...
        Animation animation= AnimationUtils.loadAnimation(Home2.this,R.anim.bounce);
