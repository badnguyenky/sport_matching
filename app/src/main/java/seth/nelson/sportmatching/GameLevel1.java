...
public class GameLevel1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l1Bgm = MediaPlayer.create(GameLevel1.this,R.raw.bgm_l1);
        l1Bgm.start();
        l1Bgm.setLooping(true);
        ...
        restart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), GameLevel1.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(GameLevel1.this, Home1.class));
                finish();
            }
        });
    ...
    private void calculateFootball() {
        Animation animation= AnimationUtils.loadAnimation(GameLevel1.this,R.anim.sample_anim);
        Animation animation2= AnimationUtils.loadAnimation(GameLevel1.this,R.anim.sample_anim2);
        if (firstCard == secondCard) {
            ...
            great = MediaPlayer.create(GameLevel1.this,R.raw.but_great);
            if(great!=null){
                great.start();
            }
            ...
            wrong2 = MediaPlayer.create(GameLevel1.this,R.raw.but_wrong2);
            if(wrong2!=null){
                wrong2.start();
            }
    ...
    private void checkEndFootball() {
        if (iv_1.getVisibility() == View.INVISIBLE &&
            ...
            highscore = MediaPlayer.create(GameLevel1.this,R.raw.but_highscore);
            if(highscore!=null){
                highscore.start();
            }
    ...
    public void showGuideFootball() {
        ...
        sure_guide.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                goodluck = MediaPlayer.create(GameLevel1.this,R.raw.but_goodluck);
                if(goodluck!=null){
                    goodluck.start();
                }
                dialog.dismiss();
