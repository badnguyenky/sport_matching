...
public class GameLevel3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l3Bgm = MediaPlayer.create(GameLevel3.this,R.raw.bgm_l3);
        l3Bgm.start();
        l3Bgm.setLooping(true);
    ...
    private void calculateFootball() {
        Animation animation= AnimationUtils.loadAnimation(GameLevel3.this,R.anim.sample_anim);
        Animation animation2= AnimationUtils.loadAnimation(GameLevel3.this,R.anim.sample_anim2);
        if (firstCard == secondCard) {
            ...
            great = MediaPlayer.create(GameLevel3.this,R.raw.but_great);
            if(great!=null){
                great.start();
            }
            ...
            wrong2 = MediaPlayer.create(GameLevel3.this,R.raw.but_wrong2);
            if(wrong2!=null){
                wrong2.start();
            }
        }
    ...
    private void checkEndFootball() {
        if (iv_1.getVisibility() == View.INVISIBLE &&
            ...
            highscore = MediaPlayer.create(GameLevel3.this,R.raw.but_highscore);
            if(highscore!=null){
                highscore.start();
            }
    ...
    public void showGuideFootball() {
        ...
        sure_guide.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                goodluck = MediaPlayer.create(GameLevel3.this,R.raw.but_goodluck);
                if(goodluck!=null){
                    goodluck.start();
                }
                dialog.dismiss();
    ...
    private void frontOfCardsResources() {
        ...
        image9 = R.drawable.a10;
        image10 = R.drawable.a11;
        image11 = R.drawable.a1;
        image12 = R.drawable.a12;
        image13 = R.drawable.a3;
        image14 = R.drawable.a4;
        image15 = R.drawable.a9;
        image16 = R.drawable.a6;
        image17 = R.drawable.a7;
        image18 = R.drawable.a8;
        image19 = R.drawable.a10;
        image20 = R.drawable.a11;
